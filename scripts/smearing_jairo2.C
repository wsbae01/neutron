...
void smearing_jairo2(double muonSmear = 0.04, double pipmSmear = 0.04, double neutronSmear = 0.2, double protonSmear = 0.1, double pi0Smear = 0.1, int onlyMuon=0, int incNeutron=1, int fileLimit = 40, TString filepath = "/dune/app/users/gyang/genie-0.0-0.101/", int caseN = 3) {
